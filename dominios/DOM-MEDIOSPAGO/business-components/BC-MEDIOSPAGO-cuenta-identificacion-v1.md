...
- **Referencia al estandar**: STD-bian-current-accounts
...
|---|---|
| Usado por (MC) | MC-MEDIOSPAGO-identificacion-cuenta-v1 |
...
No aplica — `major_branch_strategy: evolution` (ver v2 como evolucion de este).
